...
def HG_T(double t, wat.Units iunits, wat.Units ounits):
...
def K_PT(double p, double t, wat.Units iunits, wat.Units ounits):
...
def SF_T(double t, wat.Units iunits, wat.Units ounits):
...
def SG_T(double t, wat.Units iunits, wat.Units ounits):
...
def HF_P(double p, wat.Units iunits, wat.Units ounits):
...
def HG_P(double p, wat.Units iunits, wat.Units ounits):
...
def S_PH(double p, double h, wat.Units iunits, wat.Units ounits):
